...
class Department(db.Model):
    ...
    def __repr__(self):
        return f"<Department code: {self.dept_code} name: {self.dept_name} phone: {self.phone}>"
...
class Employee(db.Model):
    ...
    def __repr__(self):
        return f"<Employee id: {self.id} name: {self.name} state: {self.state} dept_code: {self.dept_code}>"
